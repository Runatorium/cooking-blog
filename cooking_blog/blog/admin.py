...
class RecipeAdmin(admin.ModelAdmin):
    ...
    list_display = ('title', 'author', 'category', 'prep_time', 'gluten_free', 'lactose_free', 'created_at', 'is_published')
    list_filter = ('category', 'is_published', 'gluten_free', 'lactose_free', 'created_at')
